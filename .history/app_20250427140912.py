...
def set_led_color():
    data = request.get_json()
    color_hex = data.get('color', '#ffffff')  # fallback to white
    ...
    return jsonify({'status': 'success', 'color_set_to': rgb})
...
def stocks_data():
    ...
    API_KEY = "A79E9AHKRPHVZROI"  # (or whatever your new API key is)
